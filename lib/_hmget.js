module.exports = function (Redis_wrapper) {
   ...
   * @param {object[]} opts.keyNames - an array of keyNames to be retrieved
  ...
  Redis_wrapper.prototype._hmget = function (opts) {
    ...
    var schema = {
      ...
      required            : ["hashName", "keyNames", "should_be_registered"],
    ...
    return Promise.resolve()
      ...
      .then(function () {
        return redis_client.hmgetAsync(opts.hashName, opts.keyNames)
          .then(function (d) {
            return d;
          });
      })
      .then(function (d) {
        ...
        return Promise.map(d, function (d, i) {
            ...
            if (!d) {
              final_object[opts.keyNames[i]] = null;
              return true;
            }
            ...
            if (!opts.max_life_seconds) {
              final_object[opts.keyNames[i]] = stored_value.data;
              return true;
            }
