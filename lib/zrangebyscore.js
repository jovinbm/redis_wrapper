 ...
 * @param {number} params.max_score - inclusive - can bet -Infinity|Infinity
 * @param {number} params.min_score - inclusive - can bet -Infinity|Infinity
...
module.exports = function (params) {
  ...
  return BPromise.resolve()
    ...
    .then(function () {
      ...
      return client.zrangebyscore(args);
    });
};